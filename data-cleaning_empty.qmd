...
```{r}
unique(snowsurvey_fixed$Site)
length(unique(snowsurvey_fixed$Site))

unique(snowsurvey_fixed$Year)
length(unique(snowsurvey_fixed$Year))

unique(snowsurvey_fixed$Date)
length(unique(snowsurvey_fixed$Date))

unique(snowsurvey_fixed$Plot)
length(unique(snowsurvey_fixed$Plot))

unique(snowsurvey_fixed$Location)
length(unique(snowsurvey_fixed$Location))

unique(snowsurvey_fixed$Snow_cover)
length(unique(snowsurvey_fixed$Snow_cover))

unique(snowsurvey_fixed$Water_cover)
length(unique(snowsurvey_fixed$Water_cover))

unique(snowsurvey_fixed$Land_cover)
length(unique(snowsurvey_fixed$Land_cover))

unique(snowsurvey_fixed$Total_cover)
length(unique(snowsurvey_fixed$Total_cover))

unique(snowsurvey_fixed$Observer)
length(unique(snowsurvey_fixed$Observer))

unique(snowsurvey_fixed$Notes)
length(unique(snowsurvey_fixed$Notes))
```
